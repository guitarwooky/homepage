  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        {/* High quality Unsplash image for Acoustic Guitar vibe */}
        <img
          src="https://images.unsplash.com/photo-1485278537138-4e8911a13c02?q=80&w=2564&auto=format&fit=crop"
          alt="Acoustic Guitar Background"
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <div className="inline-block px-4 py-1 mb-6 border border-brand-gold/50 rounded-full animate-fade-in-up bg-brand-dark/30 backdrop-blur-sm">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white mb-8 leading-tight drop-shadow-2xl animate-fade-in-up delay-100">
          손끝에서 피어나는 <br />
          <span className="italic text-brand-gold">감성 핑거스타일</span>
        </h1>
        <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-light leading-relaxed animate-fade-in-up delay-200 drop-shadow-md">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-300">
          ...
          <a
            ...
            className="px-8 py-4 border border-white text-white font-medium rounded-full hover:bg-white/10 transition-all duration-300 backdrop-blur-sm cursor-pointer bg-black/20"
          >
            교재 구매하기
          </a>
        </div>
